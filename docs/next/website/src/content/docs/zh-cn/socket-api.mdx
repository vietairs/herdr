...
| 智能体 | `agent.list`、`agent.get`、`agent.read`、`agent.explain`、`agent.prompt`、`agent.wait`、`agent.send_keys`、`agent.rename`、`agent.focus`、`agent.start`、`agent.view.set`、`agent.view.clear` |
