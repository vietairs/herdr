...
pub fn capture(
    ...
    SessionSnapshot {
        ...
        // Sidebar width/split are now client-owned presentation state
        // (`client::shell::preferences`), persisted next to the client's own
        // endpoint config rather than in the server-owned session snapshot.
        sidebar_width: None,
