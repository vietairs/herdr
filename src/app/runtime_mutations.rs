...
impl App {
    pub(crate) fn dispatch_tui_runtime_mutation(
        &mut self,
        id: &'static str,
        method: Method,
    ) -> String {
        self.dispatch_tui_api_request(id, method)
    }

    pub(crate) fn dispatch_tui_deferred_runtime_mutation(
        &mut self,
        id: &'static str,
        method: Method,
    ) -> Option<String> {
        self.dispatch_tui_deferred_api_request(id, method)
    }
    ...
    pub(crate) fn runtime_tab_focus(&mut self, id: &'static str, tab_id: String) -> String {
        self.dispatch_tui_runtime_mutation(id, Method::TabFocus(TabTarget { tab_id }))
    }

    pub(crate) fn runtime_tab_close(&mut self, id: &'static str, tab_id: String) -> String {
        self.dispatch_tui_runtime_mutation(id, Method::TabClose(TabTarget { tab_id }))
    }

    pub(crate) fn runtime_pane_focus(&mut self, id: &'static str, pane_id: String) -> String {
        self.dispatch_tui_runtime_mutation(id, Method::PaneFocus(PaneTarget { pane_id }))
    }

    pub(crate) fn runtime_pane_close(&mut self, id: &'static str, pane_id: String) -> String {
        self.dispatch_tui_runtime_mutation(id, Method::PaneClose(PaneTarget { pane_id }))
    }
}
