...
impl ClientShellState {
    ...
    pub(super) fn open_rename_pane_overlay(&mut self) {
        ...
        self.overlay = Some(ClientShellOverlay::Rename(ClientRenameOverlay {
            ...
            input: TextEditor::new(
                ...
                pane.name_source != crate::workspace::naming::NameSource::Override,
            ),
    ...
    pub(super) fn insert_overlay_text(&mut self, text: &str) -> bool {
        ...
        if self.insert_remote_mount_overlay_text(text) {
            return true;
        }
    ...
    pub(super) fn route_overlay_key(
        ...
        if self.route_remote_mount_overlay_key(key, outcome) {
            return;
        }
