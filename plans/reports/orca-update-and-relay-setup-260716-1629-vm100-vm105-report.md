...
|---|---|---|
| Address | `192.0.2.161` (x86_64, host `gpu-ml`) | `192.0.2.163` (x86_64, host `bio-1-ubuntu`) |
...
| Saved environment | `ws://192.0.2.161:45511` | `ws://192.0.2.163:33155` |
...
ExecStart=/opt/orca/orca-linux.AppImage serve --port 6768 --no-sandbox --disable-gpu --disable-gpu-sandbox --pairing-address 192.0.2.161
Restart=on-failure
RestartSec=5
