...
Date: 2026-07-16 | Host: `appn-ltu-vm-100` (192.0.2.161, gpu-ml, x86_64)
...
| Remote reach from Mac | — | **proven** (`ws://192.0.2.161:45511`) |
...
- **Transport**: `nc 192.0.2.161 45511` succeeds from Mac.
...
1. **VM105 not touched** — task scoped to VM100 only. VM105 is registered at `ws://192.0.2.163:33155` (plan's "IP TBD" answered); its version/serve state unverified. Want the same update+enable pass there?
