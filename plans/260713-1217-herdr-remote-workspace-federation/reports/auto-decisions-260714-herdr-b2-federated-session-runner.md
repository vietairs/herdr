...
Ran an ISOLATED headless dial `~/herdr-fed/herdr --remote 192.0.2.163 --remote-workspace --session fedsmoke`
...
`~/herdr-fed/herdr --remote 192.0.2.163 --remote-workspace --session fedsmoke` (the Mac serves only as the ssh
