...
## Symptom
`~/herdr-fed/herdr --remote 192.0.2.163 --remote-workspace --session fedsmoke` on vm100
renders a sidebar entry `192.0.2.163#fed...` (correct federation `HostKey` format,
