...
**What:** `cargo run -- --remote localhost 192.0.2.163 192.0.2.161 --remote-workspace` works live: local + two remote federated workspaces in one TUI. Closes the out-of-env two-machine smoke acceptance item.
